        ...
        <div className="hidden md:flex md:w-1/2 bg-gradient-to-br from-gray-900 via-gray-800 to-black p-12 flex-col justify-between text-white relative overflow-hidden">
          ...
          <div className="relative z-10">
            ...
            <h1 className="text-4xl font-bold leading-tight mb-4">
              Master Your Trades.<br />Own Your Success.
            </h1>
            <p className="text-gray-200 text-lg max-w-sm">
              The premier journaling platform for serious traders to track, analyze, and optimize their performance.
            </p>
          </div>
          ...
          <div className="max-w-md w-full mx-auto">
            ...
            <form className="flex flex-col gap-5" onSubmit={handleLogin}>
              ...
              <div>
                <div className="flex items-center justify-between mb-1.5">
                  ...
                  <a href="#" className="text-sm font-medium text-black hover:text-gray-800">Forgot password?</a>
                </div>
              ...
              {error && (
                <div
                  className="text-red-600 text-sm text-left p-3 mt-1 animate-fade-in border-l-4 border-red-500 bg-red-50 rounded-r-lg font-medium"
                  role="alert"
                  aria-live="polite"
                >
                  {error}
              ...
              <button
                type="submit"
                disabled={isLoading}
                className="w-full bg-black text-white font-semibold py-3.5 flex justify-center items-center rounded-xl shadow-sm hover:shadow-gray-200/50 hover:bg-gray-800 hover:-translate-y-0.5 focus:scale-[0.98] transition-all disabled:opacity-70 disabled:cursor-not-allowed mt-2"
              >
                {isLoading ? (
            ...
            <div className="mt-8 pt-6 border-t border-gray-100">
              <p className="text-center text-sm font-medium text-gray-600">
                ...
                <a href="/register" className="text-black hover:text-gray-800 hover:underline transition-colors font-semibold">Sign up for free</a>
              </p>
            </div>
          </div>
        </div>
